...
def main():
    ...
    st.markdown("**This application extracts transaction tables from PDF files and converts them into CSV format. It currently works for State Bank of India (SBI).**")
